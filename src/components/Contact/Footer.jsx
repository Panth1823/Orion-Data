...
const ReachIcon = ({ type }) => {
  ...
  const icons = {
    phone: (
      <svg {...commonProps}>
        <path d="M6.2 4.4 8.5 9l-2 1.3c1 2.2 2.7 3.9 5 5l1.3-2 4.6 2.3-.8 3.1c-.2.7-.8 1.1-1.5 1.1C8.1 19.8 2.2 13.9 2.2 6.9c0-.7.4-1.3 1.1-1.5l2.9-1Z" stroke="currentColor" strokeWidth="2" strokeLinejoin="round" />
      </svg>
    ),
    mail: (
      <svg {...commonProps}>
        <path d="M3 5.5h16v11H3v-11Z" stroke="currentColor" strokeWidth="2" />
        <path d="m4 6.5 7 5 7-5" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    ),
    pin: (
      <svg {...commonProps}>
        <path d="M17 9.5c0 4.5-6 9.5-6 9.5s-6-5-6-9.5a6 6 0 1 1 12 0Z" stroke="currentColor" strokeWidth="2" />
    ...
    <footer className="contact-footer">
          ...
          <div className="contact-reach__cards">
            ...
            <article className="contact-reach-card">
              <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                ...
                <path d="M3 11h16M11 3c2 2.2 3 4.9 3 8s-1 5.8-3 8M11 3c-2 2.2-3 4.9-3 8s1 5.8 3 8" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" />
              </svg>
              <p>Follow Us</p>
              <div className="contact-reach-card__socials" aria-label="Social links">
                <a href="https://www.facebook.com" aria-label="Facebook">f</a>
                <a href="https://www.instagram.com" aria-label="Instagram"><span /></a>
      ...
      <section className="footer-panel">
        ...
        <div className="footer-panel__inner">
          ...
          <nav className="footer-panel__nav" aria-label="Contact footer navigation">
          ...
          <div className="footer-panel__meta">
            ...
            <div className="footer-panel__socials" aria-label="Social links">
              <a href="https://www.facebook.com" aria-label="Facebook">f</a>
              <a href="https://www.instagram.com" aria-label="Instagram"><span className="footer-panel__instagram" /></a>
              <a href="https://x.com" aria-label="X">X</a>
            </div>
